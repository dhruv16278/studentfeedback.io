...
In the Feedback Section:- Feedback can be given through star rating and comments could be added as well. The Faculty would have access to only feedback, not the names of the students giving the feedback, but would be seperately stored in the DB. Also, once if a students gives a feedback, won't be able to do it again
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#66CCFF">
		<span style="color:#FFFFFF">Developed By ....... 	<a href="dhruv-desai">dhruv</a> </span>
	</div>
    <!-- jQuery -->
